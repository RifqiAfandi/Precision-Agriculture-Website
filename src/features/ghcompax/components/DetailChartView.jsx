      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 animate-slide-in-right" style={{ animationDelay: '0.1s', animationFillMode: 'backwards' }}>
        <div className="flex items-center space-x-2 sm:space-x-3">
          <Button
            ...
            variant="outline"
            size="sm"
            className="h-7 w-7 sm:h-8 sm:w-8 p-0 flex-shrink-0 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 dark:hover:bg-emerald-600 dark:hover:text-white dark:hover:border-emerald-600 dark:text-gray-300 transition-all duration-300"
          >
