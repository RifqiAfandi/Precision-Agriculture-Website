  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 dark:from-gray-900 dark:via-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 z-50 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-white border border-gray-200 dark:border-transparent p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 ${isPageLoaded ? 'animate-fade-in' : 'opacity-0'}`}
